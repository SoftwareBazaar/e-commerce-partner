-- ============================================================================
-- ROBERT TRADING TOOLS - COMPLETE DATABASE SCHEMA
-- ============================================================================
...
CREATE INDEX idx_custom_ea_requests_user_id ON custom_ea_requests(user_id);
...
CREATE INDEX idx_mentorship_packages_slug ON mentorship_packages(slug);
CREATE INDEX idx_mentorship_packages_is_active ON mentorship_packages(is_active);
...
CREATE UNIQUE INDEX idx_cart_items_unique ON cart_items(user_id, product_id, mode);
