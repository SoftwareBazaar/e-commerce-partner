...
const Contact = () => {
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const senderName = String(fd.get("name"));
    ...
    if (!emailResult.success) {
      ...
      toast({ 
        title: "Message sent", 
        description: "We'll reply within 24 hours. (Email notification pending)",
        variant: "default"
      });
    } else {
      toast({ 
        title: "Message sent", 
        description: "Confirmation email sent. We'll reply within 24 hours." 
      });
    }
